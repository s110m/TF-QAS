...
#         ) # Note: this encoder layer has forward itself.
...
#         else:
#             self.encoder(self.q_device, x) # During encoder and other parts, the state in q_device will be changed.
...
#         x = F.log_softmax(x, dim=1) # Note: 
#         return x

#     @property # this decorator allow us to use model.arch_space (not need to write model.arch_space()) directly. It has also more benefits. Search for @property decorator in chatgpt.
#     def arch_space(self):
#         space = []
